...
const dbs = [
  { icon: mysql_icon, name: "MySQL", height: 64 },
  { icon: postgres_icon, name: "PostgreSQL", height: 40 },
  { icon: sqlite_icon, name: "SQLite", height: 52 },
  { icon: mariadb_icon, name: "MariaDB", height: 52 },
  { icon: sql_server_icon, name: "SQL Server", height: 52 },
  { icon: oraclesql_icon, name: "Oracle", height: 100 },
];

const tables = [
  {
    name: "users", left: "6%", top: "6%",
    fields: [
      ["id","PK","accent"], ["username",null,null],
      ["email",null,null], ["password_hash",null,null],
      ["created_at",null,null],
    ],
  },
  {
    name: "roles", left: "6%", top: "46%",
    fields: [
      ["id","PK","accent"], ["name",null,null],
      ["permissions",null,null],
    ],
  },
  {
    name: "orders", left: "37%", top: "28%",
    fields: [
      ["id","PK","accent"], ["user_id","FK","amber"],
      ["total",null,null], ["status",null,null],
      ["created_at",null,null],
    ],
  },
  {
    name: "products", left: "68%", top: "6%",
    fields: [
      ["id","PK","accent"], ["name",null,null],
      ["price",null,null], ["category_id","FK","amber"],
      ["stock",null,null],
    ],
  },
  {
    name: "categories", left: "68%", top: "52%",
    fields: [
      ["id","PK","accent"], ["name",null,null],
      ["slug",null,null],
    ],
  ...
  {
    name: "order_items", left: "37%", top: "60%",
    fields: [
      ["id","PK","accent"], ["order_id","FK","amber"],
      ["product_id","FK","amber"], ["quantity",null,null],
      ["price",null,null],
    ],
  },
];
...
function ErdCanvas() {
  ...
  return (
    <div className="relative w-full" style={{ height: 520 }}>
      ...
      {tables.map((t, i) => (
        <div key={i}
          className="absolute rounded-lg border overflow-hidden backdrop-blur-sm transition-all duration-500 hover:z-10"
          style={{
            width: 155,
            ...
            zIndex: 2,
            animation: `erd-drift ${4 + i * 0.4}s ease-in-out infinite alternate`,
    ...
    <div style={{ backgroundColor: "var(--bg-primary)", color: "var(--text-primary)" }} className="overflow-x-hidden">
      ...
      <section className="relative overflow-hidden" style={{ minHeight: "100dvh" }}>
        <div className="pointer-events-none absolute inset-0 opacity-[0.35]"
          style={{
            backgroundImage:
              "radial-gradient(rgba(0,212,170,0.12) 1px, transparent 1px)",
            ...
            <div className="mx-auto max-w-5xl flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
              <div>
                ...
                <h1 className="text-[clamp(2.8rem,6vw,5rem)] font-extrabold leading-[1] tracking-tight"
                  style={{
                    background: "linear-gradient(135deg, #00d4aa 0%, #00f5d4 60%, #a8ffec 100%)",
              ...
              <div className="flex flex-wrap items-center gap-3">
                <button onClick={goStart} disabled={loading}
                  className="cursor-pointer rounded-full px-7 py-3 text-sm font-semibold transition-all duration-200 hover:opacity-90 active:scale-[0.97] whitespace-nowrap"
                  style={{
                    color: "#09090b",
      ...
      <section id="features" className="py-12 px-6">
        ...
        <div className="mx-auto max-w-5xl grid grid-cols-1 xl:grid-cols-3 gap-3">
      ...
      <section className="py-10 px-6">
        <div className="mx-auto max-w-4xl text-center">
          <span className="text-[10px] font-semibold uppercase tracking-[0.25em]"
            style={{color:"var(--accent)"}}>支持的数据库</span>
          <h2 className="text-2xl font-bold tracking-tight mt-1 mb-5"
            style={{color:"var(--text-primary)"}}>
            兼容主流关系型数据库
          </h2>
          <div className="flex flex-wrap items-center justify-center gap-5" style={{opacity: 0.5}}>
            {dbs.map((db, i) => (
              ...
              >
                <img src={db.icon} alt={db.name} style={{ height: db.height }} />
      ...
      <section className="px-6 pb-14">
        <div className="mx-auto max-w-lg text-center">
          ...
          >
            ...
            <button onClick={goStart} disabled={loading}
              className="cursor-pointer rounded-full px-8 py-3 text-sm font-semibold transition-all duration-200 hover:opacity-90 active:scale-[0.97]"
              style={{
                color: "#09090b",
                backgroundColor: "var(--accent)",
